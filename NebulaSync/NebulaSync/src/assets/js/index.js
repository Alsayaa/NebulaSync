...
// ✅ Ce que ça fait : dès que l’utilisateur fait défiler un peu la page, 
// le bouton de retour en haut apparaît. Sinon, il reste caché.
...
function scrollToTopStepByStep() {
    ...
    function step() {
        ...
        // On attend 4 secondes avant de faire défiler la suivante (temps pour lire ou observer)
...
// ✅ Ce que ça fait : au lieu de remonter tout d’un coup, 
// ce script fait défiler section par section, 
// en laissant 4 secondes de pause entre chaque. Idéal pour une navigation doux et guidée.
